...
As part of my postdoctoral work in the Uricchio Lab at Tufts, I plan to examine how local environmental adaptation influences climate effects on population dynamics. This is an underdeveloped area of both eco-evolutionary theory and empirical work. Most existing ecological theory assumes that species have an invariant environmental niche across their range. However, this is an assumption we know is most likely violated: local environmental adaptation is probably common.  If we assume that a species has the same environmental requirements (e.g., precipitation, temperature) across its range, the effect of climate change will be expected to *vary* across the range. For instance, the effects of climate warming might be positive at the northern edge (where it will be cooler), and negative and the southern edge (where it will be warmer). In contrast, if we assume that the species is adapted to its local environment, then the effect of climate variation would be expected to be *similar* across the range. I intend to test these ideas with North American butterflies, using landscape genomic methods and continental-scale citizen science population censuses.  This project will also be in collaboration with Elizabeth Crone and Erik Dopman at Tufts University, and Leslie Ries at Georgetown University.
